  ...
  return (
    <div className="flex bg-black justify-center items-center h-screen overflow-hidden">
      ...
      <div className="flex justify-between bg-[#222222] rounded-lg">
       ...
       <input type="search" id="default-search" class="block ps-2 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search Mockups, Logos..." required />
...
<img src={profile} alt='...'className='h-10 m-auto'/>
      ...
      <div className='overflow-hidden overflow-y-auto h-[90%] p-1 scrollbar-hide pb-5'>
