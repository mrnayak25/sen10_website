...
function App() {
  ...
  return (
    <div className="flex bg-black justify-center items-center h-screen">
      <div className={`bg-[#222222] me-2 relative duration-300 p-2 m-2 items-center rounded-lg grid justify-items-center`}>
        {/* <img
          src={control}
        ...
        <div className="ps-1 flex-col justify-center gap-3 text-center ">

          {Menus.map((Menu, index) => (
             
            <div className='bg-[#302f2f] rounded-lg w-[90%] text-center flex justify-center my-2' key={index}>
              <div
